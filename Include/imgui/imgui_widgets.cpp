...
bool ImGui::Keybind(const char* label, int* key, bool show_label)
{
    ...
    if (*key != 0 && g.ActiveId != id) {
        ...
        strcpy_s(buf_display, "Please press key...");
    }
    ...
    window->DrawList->AddRectFilled(clickable.Min + ImVec2(0, 0), clickable.Max - ImVec2(0, 0), GetColorU32(Style::Keybind::Background), Style::Keybind::Rounding);
    window->DrawList->AddRect(clickable.Min + ImVec2(0, 0), clickable.Max - ImVec2(0, 0), GetColorU32(Style::Keybind::OutlineBackground), Style::Keybind::Rounding);
...
bool ImGui::Tab(bool selected, const char* label, const ImVec2& size_arg)
{
    ...
    if(selected || hovered) window->DrawList->AddRectFilled(bb.Min, bb.Max, GetColorU32(Style::Tab::Background), Style::Tab::Rounding);
...
bool ImGui::SubTab(bool selected, const char* label, ImVec2 size_arg)
{
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    ...
    if (selected || hovered)
    {
        ...
        window->DrawList->AddRectFilled(bb.Min, bb.Max, GetColorU32(Style::SubTab::DefBackground), Style::SubTab::Rounding);
    }
...
bool ImGui::NewCheckbox(const char* label, bool* v)
{
    ...
    it_anim->second.circle = ImLerp(it_anim->second.circle, *v ? Style::AccentColor : Style::Checkbox::CircleInactive, g.IO.DeltaTime * 6.f);
    ...
    GetWindowDrawList()->AddRectFilled(check_bb.Min + ImVec2(w - 1, 0), check_bb.Max + ImVec2(w, 0), GetColorU32(Style::Checkbox::Background), Style::Checkbox::Rounding);
    GetWindowDrawList()->AddRect(check_bb.Min + ImVec2(w - 1, 0), check_bb.Max + ImVec2(w, 0), GetColorU32(Style::Checkbox::OutlineBackground), Style::Checkbox::Rounding);
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    GetWindowDrawList()->AddRectFilled(slider_bb.Min + ImVec2(0, 4), slider_bb.Max - ImVec2(0, 4), GetColorU32(Style::Slider::Background), 30.f);
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        GetWindowDrawList()->AddCircleFilled(ImVec2(frame_bb.Min.x + it_anim->second.slow + 5, grab_bb.Max.y - 6.5), 7.f, GetColorU32(Style::Slider::CircleInactive), 30.f);
    }
